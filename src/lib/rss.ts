...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  infrastruktur: [
    "infrastruktur", "jalan tol", "jembatan", "bendungan", "waduk",
    "transportasi", "kereta api", "kai", "lrt", "mrt", "bus rapid transit",
    "brt", "transjakarta", "bandara", "pelabuhan", "terminal", "stasiun",
    "pembangunan infrastruktur", "proyek infrastruktur", "infrastruktur strategis",
    "jalan nasional", "jalan provinsi", "jalan kabupaten", "toll road",
    "konstruksi", "kontraktor", "kementerian pupr", "pupr", "pu",
    "pekerjaan umum", "perumahan rakyat", "citarum", "bendungan",
    "jalan tol trans jawa", "trans sumatera", "kereta cepat", "whoosh",
    "jakarta-bandung", "bandara internasional", "pelabuhan internasional",
  ],
  otomotif: [
    "otomotif", "kendaraan", "mobil", "motor", "sepeda motor", "mobil listrik",
    "ev", "electric vehicle", "hybrid", "plug-in hybrid", "toyota", "honda",
    "suzuki", "daihatsu", "mitsubishi", "nissan", "hyundai", "wuling",
    "yamaha", "suzuki motor", " Kawasaki", "ducati", "bmw motorrad",
    "otomotif indonesia", "iims", "gaikindo", "indonesian international motor show",
    "pameran otomotif", "peluncuran mobil", "peluncuran motor", "uji emisi",
    "emisi", "euro 4", "euro 5", "bbm", "pertamax", "pertalite", "solar",
    "bensin", "spbu", "ban", "oli", "servis", "bengkel", "dealer",
  ],
  properti: [
    "properti", "real estate", "perumahan", "rumah", "apartemen", "kondominium",
    "rusun", "rusunawa", "rumah susun", "hunian", "residensial", "komersial",
    "lahan", "tanah", "kavling", "gedung perkantoran", "mall", "pusat perbelanjaan",
    "property", "developer", "pengembang", "ciputra", "agung podomoro", "summarecon",
    "pakubuwon", "sinarmas land", "lippo", "bakrieland", "jababeka",
    "harga properti", "harga rumah", "kpr", "kredit pemilikan rumah",
    "flpp", "tabungan perumahan", "bp tapera", "real estat", "properti syariah",
    "rumah subsidi", "rumah swadaya", "relokasi", "urbanisasi", "kota baru",
  ],
  "wisata-kuliner": [
    "wisata", "pariwisata", "tourism", "travel", "liburan", "vacation",
    "destinasi", "wisata alam", "wisata budaya", "ekowisata", "geopark",
    "taman nasional", "pantai", "gunung", "danau", "air terjun", "candi",
    "museum", "wisata religi", "ziarah", "haji", "umroh", "umrah",
    "kuliner", "makanan", "minuman", "resep", "restoran", "kafe", "warung",
    "street food", "jajanan", "snack", "kopi", "teh", "cokelat",
    "festival kuliner", "festival makanan", "gastronomi", "gastronomic",
    "otw", "oleh-oleh", "khas daerah", "makanan khas", "minuman khas",
    "wisata kuliner", "kuliner nusantara", "kuliner tradisional", "kuliner modern",
    "kemenparekraf", "kementerian pariwisata", "pariwisata indonesia",
    "wonderful indonesia", "halal tourism", "wisata halal", "hotel", "resort",
    "villa", "homestay", "penginapan", "akomodasi", "travel agent",
    "tour guide", "pemandu wisata", "wisatawan", "turis", "backpacker",
  ],
  daerah: [
    "daerah", "provinsi", "kabupaten", "kota", "kecamatan", "kelurahan", "desa",
    "pemprov", "pemkab", "pemkot", "pemerintah daerah", "pemda",
    "bupati", "walikota", "gubernur", "camat", "lurah", "kepala desa",
    "pilkada", "pemilihan kepala daerah", "pilbup", "pilwalkot", "pilgub",
    "dprd", "dewan perwakilan rakyat daerah", "apbd",
    "pembangunan daerah", "perekonomian daerah", "potensi daerah",
    "umkm daerah", "produk lokal", "kampung", "desa wisata", "desa digital",
    "smart city", "kota cerdas", "kota pintar",
    "berita daerah", "info daerah", "lokal", "nusantara", "regional",
  ],
};
